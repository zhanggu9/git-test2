"""Download Samsung Electro-Mechanics daily OHLCV data in the local custom-data format."""
...
def main() -> None:
    ...
    url = f"https://query1.finance.yahoo.com/v8/finance/chart/009150.KS?{query}"
    ...
    if written == 0:
        raise RuntimeError("No Samsung Electro-Mechanics price rows were downloaded")
    print(f"Downloaded {written} daily bars to {output}")
