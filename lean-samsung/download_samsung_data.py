"""Download Samsung Electronics daily OHLCV data in the local custom-data format."""
...
def main() -> None:
    ...
    url = f"https://query1.finance.yahoo.com/v8/finance/chart/005930.KS?{query}"
    ...
    if written == 0:
        raise RuntimeError("No Samsung Electronics price rows were downloaded")
